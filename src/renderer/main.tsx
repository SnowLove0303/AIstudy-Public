...
type SettingsPage = "runtime" | "storage" | "database" | "mcp" | "shortcuts" | "updates" | "errorLogs";
...
declare global {
  interface Window {
    ...
    aistudyRuntime?: {
      ...
      storageFootprint: () => Promise<StorageFootprintReport>;
      cleanCaches: () => Promise<CacheCleanupResult>;
    ...
    <div className="settings-backdrop" role="presentation">
      <section className="settings-dialog" role="dialog" aria-modal="true" aria-label="设置">
        <aside className="settings-nav">
          ...
          <button className={activePage === "storage" ? "settings-nav-item active" : "settings-nav-item"} type="button" onClick={() => setActivePage("storage")}>
            <HardDrive size={16} />
            <span>缓存空间</span>
          </button>
