...
- `codex.md`: Codex Skill installation, local MCP registration, real-path verification, failure routing, and rollback.
...
2. Update `tool-index.md`, `workflows.md`, `codex.md`, and `claude-code.md` when their contracts are affected.
